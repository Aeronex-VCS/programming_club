...
import 'package:programming_club/features/drawer_menu/controller/drawer_state_pod.dart';
  ...
  Widget build(BuildContext context) {
    return Drawer(
      child: Consumer(builder: (context, ref, child) {
        bool expanded = ref.watch(drawerNotifierProvider);
        return ListView(
          ...
          children: [
            ...
            DrawerHeader(
              ...
              child: UserAccountsDrawerHeader(
                ...
                onDetailsPressed: () {
                  ref.read(drawerNotifierProvider.notifier).toggleDrawer();
                },
              ),
            ),
            // ListTile(
